...
Ember.PEnumerable = Ember.Mixin.create({
  /**
     ...
     on the elements of an array and invoking a callback once all
     async operations and mappings have completed.
     ...
     the original array is passed as the last argument.

     @param then {Function} the callback that is invoked once all the
     work is done. It takes as argument the new array.
